...
public class FileSizeObtainerOnWindows implements FileSizeObtainer {

	private static FileSizeObtainerOnWindows fileSizeObtainerOnWindows = null;

	public static FileSizeObtainer newInstance() {
		if(fileSizeObtainerOnWindows == null){
			fileSizeObtainerOnWindows = new FileSizeObtainerOnWindows();
		}
		return fileSizeObtainerOnWindows;
	}
