...
*
*/
package cn.edu.buaa.act.service4all.core.samanager.appliance.axis2;
...
public class WebServiceManager extends AppManager {
	...
	protected Log logger = LogFactory.getLog(WebServiceManager.class);

	@Override
	protected synchronized String generateServiceId(String appName) {
		return "WS_" + Long.toString(IDCounter.generateJobID());
	}
}
