...
*
*/
package cn.edu.buaa.act.service4all.core.samanager.appliance.appserver;
...
public class WebAppManager extends AppManager {
	...
	@Override
	protected String generateServiceId(String appName) {
		// TODO Auto-generated method stub
		return "APP_" + String.valueOf(IDCounter.generateJobID());
	}
