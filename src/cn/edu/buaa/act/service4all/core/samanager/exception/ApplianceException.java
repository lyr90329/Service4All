...
/**
 * the super class for appliance exception which can be threw out 
 * when any error about appliance happens 
 * including appliance registering, querying, updating and so on
 * 
 * @author Huangyj
 *
 */
