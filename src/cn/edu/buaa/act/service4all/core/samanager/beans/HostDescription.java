...
public class HostDescription extends ApplianceDescription {
	...
	protected String deployOperation = "saDeploy";
	
	protected String undeployEPR = null;
	protected String undeployOperation = "saUnDeploy";
	
	protected String startEPR = null;
	protected String startOperation = "restart";
	
	protected String restartEPR = null;
	protected String restartOperation = "restart";
