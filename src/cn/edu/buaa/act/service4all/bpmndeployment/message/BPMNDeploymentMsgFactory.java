...
public class BPMNDeploymentMsgFactory extends MessageFactory {
	...
	protected void writeExceptionRespMsg(Document doc, Task task) {
		...
		Element root = doc.createElement("deployResponse");
...
//	protected void writeRespMsgHeader(Document doc, Task task){
//		Element root = doc.createElement("deployResponse");
//		root.setAttribute("type", "bpmn");
//		doc.appendChild(root);
//		
