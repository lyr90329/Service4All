...
* USA
*/
package cn.edu.buaa.act.service4all.atomicws.deploy.loadbalance;
...
public class PerformanceSortor {
	...
	double weight[] = null;
	ContainerReplica[] performances;
	PerformanceRankingTable rankingTable;

	public PerformanceSortor(double weight[], ContainerReplica[] performances) {
		this.weight = weight;
...
//	}
	...
	private double[] getCPU(ContainerReplica[] performances) {
		int size = performances.length;
	...
	private double[] getMemeory(ContainerReplica[] performances) {
		int size = performances.length;
	...
	private double[] getThroughput(ContainerReplica[] performances) {
		int size = performances.length;
...
//	private int[] getServiceCount(ContainerReplica[] performances) {
//		int size = performances.length;
