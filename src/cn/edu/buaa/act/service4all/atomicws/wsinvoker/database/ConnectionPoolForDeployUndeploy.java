...
public class ConnectionPoolForDeployUndeploy{

//	private final static Log logger = LogFactory.getLog(ConnectionPoolForDeployUndeploy.class);
	...
	private static ConnectionPoolForDeployUndeploy instance = null;

	synchronized public static ConnectionPoolForDeployUndeploy getInstance() {
		if (instance == null) {
			instance = new ConnectionPoolForDeployUndeploy();
		}
		return instance;
	}


	private ConnectionPoolForDeployUndeploy() {
		init();
	}
