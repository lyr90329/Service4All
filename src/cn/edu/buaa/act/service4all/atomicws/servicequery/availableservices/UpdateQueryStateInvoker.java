...
public class UpdateQueryStateInvoker extends Invoker {

	@Override
	public Document createRequestDocument(ExchangeContext context)
			throws MessageExchangeInvocationException {
		return DocsBuilder.buildUpdateQueryStateDoc((String)context.getData(WSQueryUpdateConstants.QUERY_STATE));
	...
	public void handleResponse(Document response, ExchangeContext context)
		...
		this.getBusinessUnit().getReceiver().sendResponseMessage(context);
	}
